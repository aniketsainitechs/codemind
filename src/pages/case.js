      ...
      <div className="flex grid grid-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 pt-20 pb-10 bg-purple-50 ">
        ...
        <div className="mt-15 md:ml-10 xl:ml-10 ml-5">
          ...
          <div className="md:flex-row  items-start flex flex-col gap-3 md:gap-0 md:space-x-5">
            <button className=" text-white items-center inline-flex gap-3 font-semibold xl:text-sm text-xs py-[12px] px-4 mt-2 rounded-md  bg-black">Share Your Challenge  <ArrowRight className='w-4 h-4' /> </button>
            <button className=" text-black text-sm  bg-white  py-[10px] px-5 rounded-md border mt-2 border-gray-200">Veiw All Projects</button>
          </div>
        </div>
...
<button className='text-black bg-white hover:bg-gray-200 py-1 px-3 rounded-md  text-sm border border-gray-300'>All Projects</button>
